...
!! row  ! Stream      ! application/yang.stream
...
#according to the "api-select" rule defined in ^path-abnf^.
...
!! include-figure ietf-restconf.yang extract-to="ietf-restconf@2014-07-03.yang"
...
** Query String Parameter Examples @ex-query@
...
{{document:
    ...
    contributor "author:Rex Fernando:Cisco:rex@cisco.com";
}}

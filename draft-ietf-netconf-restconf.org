...
- plain patch: a PATCH request that can be used for simple merge
operations.
...
and MUST send a "204 No Content" Status header line instead.
...
application/yang.data+json.  same as the media-type of

...
!! include-figure ietf-restconf.yang extract-to="ietf-restconf@2014-09-26.yang"


* RESTCONF Monitoring

The "ietf-restconf-monitoring" module provides information about
the YANG modules and notification event streams available from the
server.  It is a "plain" YANG module, however implementation is
mandatory for RESTCONF servers.
...
the "module" YANG list statement in ^module^.
...
!! include-figure ietf-restconf-monitoring.yang extract-to="ietf-restconf-monitoring@2014-09-26.yang"
...
- moved 'modules' and 'streams' to new YANG module (ietf-restconf-monitoring)
...
** Encoding of key leafs in resource URIs
...
from the server in JSON format:
   ...
   GET /restconf/data/restconf-state/modules  HTTP/1.1
   Host: example.com
   Accept: application/yang.data+json,
           application/yang.errors+json
...
The server might respond as follows.
   ...
   {
     "ietf-restconf-monitoring:modules": {
       "module": [
         {
           "name" : "foo",
           "revision" : "2012-01-02",

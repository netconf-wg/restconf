...
in response to GET requests on data or collection resources.
...
!! include-figure ietf-restconf-monitoring.yang extract-to="ietf-restconf-monitoring@2014-12-09.yang"
...
- added mandatory "defaults" protocol capability URI
- added optional "with-defaults" query parameter URI
- renamed "select" parameter to "fields"

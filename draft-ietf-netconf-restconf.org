...
!! row  ! limit ! urn:ietf:params:restconf:capability:limit:1.0
!! row  ! offset ! urn:ietf:params:restconf:capability:offset:1.0
...
The value of the "limit" parameter is either an integer equal to or
greater than 1 and, or the string "unbounded".  "unbounded" is the
default.
...
The value of the "offset" parameter is an integer equal to or
